      ...
      <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-12 px-12 my-6">
        <div>
          <img
            ...
            alt="man-img"
          />
          <h1 className="text-center mt-4 text-xl font-bold">Arjun Mollik</h1>
          <h1 className="text-center ">CEO & Founder</h1>
          <p className="text-center flex justify-center items-center cursor-pointer">
            <span className="mr-2"> {FaceBook}</span>
            <span className="mr-2"> {twitter}</span>
            <span className="mr-2"> {instra}</span>
        ...
        <div>
          <img
            ...
            alt="man-img"
          />
          <h1 className="text-center mt-4 text-xl font-bold">kayma Dey</h1>
          <h1 className="text-center ">Chief Financial Officer</h1>
          <p className="text-center flex justify-center items-center cursor-pointer">
            <span className="mr-2"> {FaceBook}</span>
            <span className="mr-2"> {twitter}</span>
            <span className="mr-2"> {instra}</span>
        ...
        <div>
          <img
            className="h-60"
            src="https://i.ibb.co/PWjCVVf/women33.jpg"
            alt="man-img"
          />
          <h1 className="text-center mt-4 text-xl font-bold">Sinai Cor Gill</h1>
          <h1 className="text-center ">Marking Leader</h1>
          <p className="text-center flex justify-center items-center cursor-pointer">
            <span className="mr-2"> {FaceBook}</span>
            <span className="mr-2"> {twitter}</span>
            <span className="mr-2"> {instra}</span>
